 ...
 */
final class Version20240424092532 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX menu_section_rank_unique ON menu_section');
        $this->addSql('DROP INDEX restaurant_menu_rank_unique ON restaurant_menu');
        $this->addSql('DROP INDEX section_product_rank_unique ON section_product');
    }
